 ...
 */
@Slf4j
public class ReadMysqlResoureTuple extends RichSourceFunction<Tuple2<String,String>> {
    ...
    public void run(SourceContext<Tuple2<String, String>> sourceContext) throws Exception {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                String id = String.valueOf(resultSet.getInt("id")*10);
                log.error("readJDBC name:{}", name);
